...
import { ACTION_REF, RELEASE_TAG } from '../lib/version'
...
// The published GitHub action reference, pinned to THIS build's release tag.
// It lives in src/lib/version.ts, derived from package.json at build time, so
// there is exactly one string in the app that has to be right. The tag itself
// is cut by .github/workflows/release.yml at launch.
