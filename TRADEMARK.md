...
The hauksbee source code is licensed under Apache-2.0. The name "Hauksbee" and
the project logo are not part of that licence. This page states what that
means in practice, so nobody has to guess.

## What you can do without asking

- Use the name to refer to this project, truthfully: "built on hauksbee",
  "compatible with hauksbee", "a model pack for hauksbee".
- Redistribute unmodified releases under the project name.
- Package unmodified releases for a distribution (Homebrew, nixpkgs, AUR and
  the like) under the project name.
...
- **Merchandise, domains, and company names** incorporating the name require
  permission.
