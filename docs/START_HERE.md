...
signing and notarisation gates pass. The engine runs locally; optional datasheet
drafting sends datasheet text to the backend you chose, after a consent notice
(see [choosing a backend](models/MODELS.md#choosing-a-backend)).
