...
avr	disabled	not in this build (the permissive, Apache-2.0 download drops the GPL simavr backend). For AVR co-sim, build from source with libsimavr (scripts/install-sims.sh --avr)
