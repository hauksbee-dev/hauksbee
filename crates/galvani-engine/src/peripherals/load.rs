...
//!
//! This is the transient consumer of the `galvani-models` load profiles. It
...
//! column into the affected linear island (verified in galvani-solve). So the
...
use galvani_models::LoadProfile;
