...
//! [`Behavioral`](galvani_models::behavioral::Behavioral) layer. A behavioural
...
pub struct BehavioralDevice {
    ...
    fsm_transitions: Vec<galvani_models::behavioral::Transition>,
