...
//! and tabulate what galvani makes of boards it has never seen.
//!
//!   cargo run --release -p galvani-engine --example bind_sweep [corpus_dir]

use galvani_engine::bind_board;
use galvani_extract::ExtractedBoard;
use galvani_models::{Confidence, ModelLibrary};
