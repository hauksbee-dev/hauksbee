...
//!
//! `docs/record/KNOWN_FAULTS_VALIDATION.md` records two faults (Watchy e-paper RES#,
...
// (docs/record/KNOWN_FAULTS_VALIDATION.md) end-to-end: the unmodified corpus Watchy
