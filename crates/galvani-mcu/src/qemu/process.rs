...
//!   1. an explicit env override (`GALVANI_QEMU_XTENSA` / `GALVANI_QEMU_RISCV32`),
//!   2. a generic `GALVANI_QEMU_DIR` pointing at the fork's `bin/`,
...
impl QemuArch {
    ...
    fn env_override(self) -> &'static str {
        match self {
            QemuArch::Xtensa => "GALVANI_QEMU_XTENSA",
            QemuArch::Riscv32 => "GALVANI_QEMU_RISCV32",
        }
    }
}
...
pub fn find_qemu(arch: QemuArch) -> Result<PathBuf> {
    ...
    if let Some(dir) = std::env::var_os("GALVANI_QEMU_DIR") {
